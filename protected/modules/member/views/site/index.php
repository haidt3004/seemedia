<?php $form = $this->beginWidget('CActiveForm', array(
    ...
    <span class="link-header">
        ...
        <a href="<?php echo Yii::app()->createAbsoluteUrl('member/site/edit') ?>" class="btn-link"><?php echo TextMultilangHelper::label('edit'); ?></a>
    </span>
    </div>
    ...
    <div class="frm-edit">
        ...
        <div class="item-edit">
            ...
            <div class="ipt-edit">
                <?php echo $form->textField($model, 'email', array('class' => 'ipt', 'disabled' => true)); ?>
    ...
    <div class="frm-edit">
        <div class="item-edit">
            ...
            <div class="ipt-edit">
                <?php echo $form->textField($model, 'staff_name', array('class' => 'ipt', 'disabled' => true)); ?>
        ...
        <?php if (Yii::app()->params['first_name']) { ?>
            <div class="item-edit">
                ...
                <div class="ipt-edit">
                    <?php echo $form->textField($model, 'first_name', array('class' => 'ipt', 'disabled' => true)); ?>
        ...
        <?php if (Yii::app()->params['middle_name']) { ?>
            <div class="item-edit">
                ...
                <div class="ipt-edit">
                    <?php echo $form->textField($model, 'middle_name', array('class' => 'ipt', 'disabled' => true)); ?>
        ...
        <?php if (Yii::app()->params['last_name']) { ?>
            <div class="item-edit">
                ...
                <div class="ipt-edit">
                    <?php echo $form->textField($model, 'last_name', array('class' => 'ipt', 'disabled' => true)); ?>
        ...
        <?php if (Yii::app()->params['nationality']) { ?>
            <div class="item-edit">
                ...
                <div class="ipt-edit">
                    <?php echo $form->textField($model, 'nationality', array('class' => 'ipt', 'disabled' => true)); ?>
        ...
        <?php if (Yii::app()->params['permanent_resident']) { ?>
            <div class="item-edit">
                ...
                <div class="ipt-edit">
                    <?php echo $form->textField($model, 'permanent_resident', array('class' => 'ipt', 'disabled' => true,
        ...
        <?php if (Yii::app()->params['fin']) { ?>
            <div class="item-edit">
                ...
                <div class="ipt-edit">
                    <?php echo $form->textField($model, 'fin', array('class' => 'ipt', 'disabled' => true)); ?>
        ...
        <?php if (Yii::app()->params['marital_status']) { ?>
            <div class="item-edit">
                ...
                <div class="ipt-edit">
                    <?php echo $form->textField($model, 'marital_status', array('class' => 'ipt', 'disabled' => true,
        ...
        <?php if (Yii::app()->params['number_of_children']) { ?>
            <div class="item-edit">
                ...
                <div class="ipt-edit">
                    <?php echo $form->numberField($model, 'number_of_children', array('class' => 'ipt', 'disabled' => true)); ?>
        ...
        <?php if (Yii::app()->params['driving_license_class_type']) { ?>
            <div class="item-edit">
                ...
                <div class="ipt-edit">
                    <?php echo $form->textField($model, 'driving_license_class_type', array('class' => 'ipt', 'disabled' => true)); ?>
        ...
        <?php if (Yii::app()->params['highest_education_level']) { ?>
            <div class="item-edit">
                ...
                <div class="ipt-edit">
                    <?php echo $form->textField($model, 'highest_education_level', array('class' => 'ipt', 'disabled' => true)); ?>
        ...
        <?php if (Yii::app()->params['certification_awarded']) { ?>
            <div class="item-edit">
                ...
                <div class="ipt-edit">
                    <?php echo $form->textField($model, 'certification_awarded', array('class' => 'ipt', 'disabled' => true)); ?>
        ...
        <?php if (Yii::app()->params['office']) { ?>
            <div class="item-edit">
                ...
                <div class="ipt-edit">
                    <?php echo $form->textField($model, 'office', array('class' => 'ipt', 'disabled' => true)); ?>
        ...
        <?php if (Yii::app()->params['job_title']) { ?>
            <div class="item-edit">
                ...
                <div class="ipt-edit">
                    <?php echo $form->textField($model, 'job_title', array('class' => 'ipt', 'disabled' => true)); ?>
        ...
        <?php if (Yii::app()->params['department']) { ?>
            <div class="item-edit">
                ...
                <div class="ipt-edit">
                    <?php echo $form->textField($model, 'department', array('class' => 'ipt', 'disabled' => true)); ?>
        ...
        <?php if (Yii::app()->params['company']) { ?>
            <div class="item-edit">
                ...
                <div class="ipt-edit">
                    <?php echo $form->textField($model, 'company', array('class' => 'ipt', 'disabled' => true)); ?>
        ...
        <?php if (Yii::app()->params['gender']) { ?>
            <div class="item-edit">
                ...
                <div class="ipt-edit">
                    <?php echo $form->textField($model, 'gender', array('class' => 'ipt', 'disabled' => true,
        ...
        <?php if (Yii::app()->params['date_of_birthday']) { ?>
            <div class="item-edit">
                ...
                <div class="ipt-edit">
                    <?php echo $form->textField($model, 'dob', array('class' => 'ipt', 'disabled' => true, 'value' => date('Y-m-d', strtotime(str_replace('/', '-', $model->dob))))); ?>
        ...
        <?php if (Yii::app()->params['skills']) { ?>
            <div class="item-edit">
                ...
                <div class="ipt-edit">
                    <?php echo $form->textArea($model, 'skills', array('style' => 'width:100%;', 'cols' => 48, 'rows' => 3, 'class' => 'ipt', 'disabled' => true)); ?>
        ...
        <?php if (Yii::app()->params['educations']) { ?>
            <div class="item-edit">
                ...
                <div class="ipt-edit">
                    <?php echo $form->textArea($model, 'educations', array('style' => 'width:100%;', 'cols' => 48, 'rows' => 3, 'class' => 'ipt', 'disabled' => true)); ?>
        ...
        <?php if (Yii::app()->params['certification']) { ?>
            <div class="item-edit">
                ...
                <div class="ipt-edit">
                    <?php echo $form->textArea($model, 'certification', array('style' => 'width:100%;', 'cols' => 48, 'rows' => 3, 'class' => 'ipt', 'disabled' => true)); ?>
        ...
        <?php if (Yii::app()->params['languages']) { ?>
            <div class="item-edit">
                ...
                <div class="ipt-edit">
                    <?php echo $form->textArea($model, 'languages', array('style' => 'width:100%;', 'cols' => 48, 'rows' => 3, 'class' => 'ipt', 'disabled' => true)); ?>
        ...
        <?php if (Yii::app()->params['associations']) { ?>
            <div class="item-edit">
                ...
                <div class="ipt-edit">
                    <?php echo $form->textArea($model, 'associations', array('style' => 'width:100%;', 'cols' => 48, 'rows' => 3, 'class' => 'ipt', 'disabled' => true)); ?>
        ...
        <?php if (Yii::app()->params['about_my_self']) { ?>
            <div class="item-edit">
                ...
                <div class="ipt-edit">
                    <?php echo $form->textArea($model, 'about_my_self', array('style' => 'width:100%;', 'cols' => 48, 'rows' => 3, 'class' => 'ipt', 'disabled' => true)); ?>
    ...
    <div class="frm-edit">
        <?php if (Yii::app()->params['account_types']) { ?>
            <div class="item-edit">
                ...
                <div class="ipt-edit">
                    <?php echo $form->textField($model, 'account_types', array('class' => 'ipt', 'disabled' => true)); ?>
        ...
        <?php if (Yii::app()->params['country_of_residence']) { ?>
            <div class="item-edit">
                ...
                <div class="ipt-edit">
                    <?php echo $form->textField($model, 'country_of_residence', array('class' => 'ipt', 'disabled' => true)); ?>
        ...
        <?php if (Yii::app()->params['work_email_address']) { ?>
            <div class="item-edit">
                ...
                <div class="ipt-edit">
                    <?php echo $form->textField($model, 'work_email_address', array('class' => 'ipt', 'disabled' => true)); ?>
        ...
        <?php if (Yii::app()->params['personal_email_address']) { ?>
            <div class="item-edit">
                ...
                <div class="ipt-edit">
                    <?php echo $form->textField($model, 'personal_email_address', array('class' => 'ipt', 'disabled' => true)); ?>
        ...
        <?php if (Yii::app()->params['house_address']) { ?>
            <div class="item-edit">
                ...
                <div class="ipt-edit">
                    <?php echo $form->textArea($model, 'address', array('style' => 'width:100%;', 'cols' => 48, 'rows' => 3, 'class' => 'ipt', 'disabled' => true)); ?>
        ...
        <?php if (Yii::app()->params['secondary_address']) { ?>
            <div class="item-edit">
                ...
                <div class="ipt-edit">
                    <?php echo $form->textArea($model, 'secondary_address', array('style' => 'width:100%;', 'cols' => 48, 'rows' => 3, 'class' => 'ipt', 'disabled' => true)); ?>
        ...
        <?php if (Yii::app()->params['house_phone_number']) { ?>
            <div class="item-edit">
                ...
                <div class="ipt-edit">
                    <?php echo $form->textField($model, 'home_phone_number', array('class' => 'ipt', 'disabled' => true)); ?>
        ...
        <?php if (Yii::app()->params['work_phone_number']) { ?>
            <div class="item-edit">
                ...
                <div class="ipt-edit">
                    <?php echo $form->textField($model, 'work_phone_number', array('class' => 'ipt', 'disabled' => true)); ?>
        ...
        <?php if (Yii::app()->params['mobile_phone']) { ?>
            <div class="item-edit">
                ...
                <div class="ipt-edit">
                    <?php echo $form->textField($model, 'phone', array('class' => 'ipt', 'disabled' => true)); ?>
        ...
        <?php if (Yii::app()->params['twitter_accounts']) { ?>
            <div class="item-edit">
                ...
                <div class="ipt-edit">
                    <?php echo $form->textField($model, 'twitter_accounts', array('class' => 'ipt', 'disabled' => true)); ?>
        ...
        <?php if (Yii::app()->params['im_accounts']) { ?>
            <div class="item-edit">
                ...
                <div class="ipt-edit">
                    <?php echo $form->textField($model, 'im_accounts', array('class' => 'ipt', 'disabled' => true)); ?>
        ...
        <?php if (Yii::app()->params['yahoo_accounts']) { ?>
            <div class="item-edit">
                ...
                <div class="ipt-edit">
                    <?php echo $form->textField($model, 'yahoo_accounts', array('class' => 'ipt', 'disabled' => true)); ?>
        ...
        <?php if (Yii::app()->params['skype_accounts']) { ?>
            <div class="item-edit">
                ...
                <div class="ipt-edit">
                    <?php echo $form->textField($model, 'skype_accounts', array('class' => 'ipt', 'disabled' => true)); ?>
        ...
        <?php if (Yii::app()->params['viber_accounts']) { ?>
            <div class="item-edit">
                ...
                <div class="ipt-edit">
                    <?php echo $form->textField($model, 'viber_accounts', array('class' => 'ipt', 'disabled' => true)); ?>
        ...
        <?php if (Yii::app()->params['whatsapp']) { ?>
            <div class="item-edit">
                ...
                <div class="ipt-edit">
                    <?php echo $form->textField($model, 'whatsapp', array('class' => 'ipt', 'disabled' => true)); ?>
        ...
        <?php if (Yii::app()->params['facebook_accounts_url']) { ?>
            <div class="item-edit">
                ...
                <div class="ipt-edit">
                    <?php echo $form->textField($model, 'facebook_accounts_url', array('class' => 'ipt', 'disabled' => true)); ?>
        ...
        <?php if (Yii::app()->params['emergency']) { ?>
            <div class="item-edit">
                ...
                <div class="ipt-edit">
                    <?php echo $form->textArea($model, 'emergency', array('style' => 'width:100%;', 'cols' => 48, 'rows' => 3, 'class' => 'ipt', 'disabled' => true)); ?>
        ...
        <?php if (Yii::app()->params['emergency_contact_person']) { ?>
            <div class="item-edit">
                ...
                <div class="ipt-edit">
                    <?php echo $form->textField($model, 'emergency_contact_person', array('class' => 'ipt', 'disabled' => true)); ?>
        ...
        <?php if (Yii::app()->params['relationship_of_emergency_contact_person']) { ?>
            <div class="item-edit">
                ...
                <div class="ipt-edit">
                    <?php echo $form->textField($model, 'relationship_of_emergency_contact_person', array('class' => 'ipt', 'disabled' => true)); ?>
        ...
        <?php if (Yii::app()->params['emergency_contact_number']) { ?>
            <div class="item-edit">
                ...
                <div class="ipt-edit">
                    <?php echo $form->textField($model, 'emergency_contact_number', array('class' => 'ipt', 'disabled' => true)); ?>

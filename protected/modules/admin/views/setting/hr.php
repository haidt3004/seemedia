    ...
    <ul class="nav nav-tabs">
        ...
        if (SettingForm::$settingDefine && is_array(SettingForm::$settingDefine)):
            foreach (SettingForm::$settingDefine as $key => $item):
                ...
                ?>
                <?php if ($key == "hrsetting") { ?>
                <li class="active">
                    <a href="#<?php echo $key; ?>" data-toggle="tab"><?php echo $itemObject->label ?></a>
                </li>
            <?php } else { ?>
                <li class="hidden">
                    <a href="#<?php echo $key; ?>" data-toggle="tab"><?php echo $itemObject->label ?></a>
    ...
    <div class="tab-content">
        ...
        if (SettingForm::$settingDefine && is_array(SettingForm::$settingDefine)):
            foreach (SettingForm::$settingDefine as $key => $item):
                $itemObject = (object)$item;
                ?>
                <div class="<?php echo ($key == "hrsetting") ? 'tab-pane active' : 'tab-pane hidden'; ?>" id="<?php echo $key; ?>">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><span
                                    class="glyphicon glyphicon-cog"></span> <?php echo $itemObject->label; ?></h3>
                        </div>
                                    ...
                                    foreach ($itemObject->items as $data):
                                        ...
                                        <div class="form-group form-group-sm">
                                            ...
                                            elseif ($dataObj->controlTyle == 'checkbox'):
                                                echo '<div class="col-sm-3">' . $form->checkbox($model, $dataObj->name, array_merge($dataObj->htmlOptions, array('class' => ""))) . $unit . $note . '<em style="position: relative;bottom: 2px;left: 20px;"></em></div>';

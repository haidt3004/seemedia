...
<div class="panel panel-default">
	...
	<div class="panel-body">
		...
		$columnArray = array_merge($columnArray, array(
			...
			// 	'name' => "title",
			// 	'type' => 'html',
			// 	// 'value' => '$data->level > 0 ? $data->buildLevelTreeCharacter($data->level) .$data->showTile() . "</span>": $data->title'
   //              'value'=>'$data->showTile()',         
			// ),
			...
			array(
				'header' => "Link",
				'name' => "short_content",
				'value' => 'strlen($data->short_content) > 100 ? substr($data->short_content, 0, 100) . " ..." : $data->short_content'
			),
			array(
				'header' => "Status",
				'name' => 'status',

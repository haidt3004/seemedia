	...
	<div class="panel-body">
		<div class="form">
			...
			<div class='form-group form-group-sm'>
				<?php echo $form->labelEx($model, 'author', array('label' => 'Staff name','class' => 'col-sm-1 control-label')); ?>
				<div class="col-sm-3">
					<?php echo $form->textField($model, 'author', array('class' => 'form-control', 'maxlength' => 255)); ?>
...
<!--			<div class="form-group form-group-sm">-->
<!--				--><?php //echo $form->labelEx($model, 'content', array('label' => 'Message','class' => 'col-sm-1 control-label')); ?>
<!--				<div class="col-sm-10">-->

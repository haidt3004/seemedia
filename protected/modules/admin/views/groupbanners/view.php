...
?><div class="panel panel-default">
	...
	<div class="panel-body">
		...
		$this->widget('zii.widgets.CDetailView', array(
			...
			'attributes' => array(
				array(
					'name' => 'group_banner_type',
					'value' => $model->getGroupBannerType(),
				),
				'name',
				array(
					'name' => 'type',
				...
				array(
					'name' => 'display_in_url',
					'type' => 'ntext',
					'visible' => $model->checkVisible('display_in_url')
				),
				array(
					'label' => 'Recommended Size (pixel)',
					'value' => $model->recommended_width . 'x' . $model->recommended_height,
				),
			),
		));
		?>

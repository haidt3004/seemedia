...
Yii::app()->clientScript->registerScript('ajaxupdate', "
    $('#group-banner-grid a.ajaxupdate').on('click', function() {
        $.fn.yiiGridView.update('group-banner-grid', {
            type: 'POST',
            url: $(this).attr('href'),
            success: function() {
        ...
        $columnArray = array_merge($columnArray, array(
			...
			array(
                ...
                (
                    'Banner' => array
                        (
                        'label' => CHtml::image(Yii::app()->theme->baseUrl."/images/view_gallery.png","View banner item",array('style'=>'width:16px; margin-left:3px;')),
                        'url' => 'Yii::app()->createUrl("/admin/detailbanners",array("group_id"=>$data->id))',
                        'options'=>array('title'=>'View banner item', 'target'=>'_blank'),

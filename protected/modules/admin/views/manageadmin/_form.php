	...
	<div class="panel-body">
		<div class="form">
				...
				<div class="col-sm-3">
					<?php 
                                        if ($model->isNewRecord) {
                                            echo $form->textField($model, 'username', array('size' => 47, 'maxlength' => 250, 'class' => "form-control")); 
                                        } else {
                                            echo $form->textField($model, 'username', array('size' => 47, 'maxlength' => 250, 'class' => "form-control", "disabled" => "disabled")); 
                                        }
                                        ?>
            ...
            <div class="form-group form-group-sm">
				...
				<div class="col-sm-3">
                    <?php echo $form->dropDownList($model, 'role_id', Roles::loadItems(), array('class' => 'form-control')); ?>
			...
			<?php if(($model->scenario == 'editAdmin' && Yii::app()->user->id != $_GET['id']) || $model->scenario == 'createAdmin') { ?>
			<div class="form-group form-group-sm">

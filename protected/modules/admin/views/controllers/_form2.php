...
<script type="text/javascript">
    ...
    /**
    * @Author: ANH DUNG Jun 29, 2015
    * @Todo: something
    */
    function fnBindCheckAllOneRole(){
        $('body').on('click', '.role_check_all', function () {
            var div = $(this).closest('.role_block').find('.box_item_check');
            if($(this).is(':checked')){
                div.find('input:checkbox').attr('checked',false);
                div.find('input:checkbox').trigger('click');
            }
            else{

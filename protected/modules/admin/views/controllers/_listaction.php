...
?>
<div class="form-group form-group-sm role_block">
	<label class="col-sm-1 control-label"><?php echo $role->role_name; ?><br>
        <input type="checkbox" class="role_check_all"><a class="" href="javascript:void(0)" style="color: red;">Check All Role</a>
    </label>
	
	<div class="col-sm-10 box_item_check">
		<?php 

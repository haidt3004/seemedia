    ...
    <div class="panel-body">
        ...
        <div class="col-sm-4">
            <div class="form-group form-group-sm">
                <?php echo $form->labelEx($model, 'language_id', array('class' => 'col-sm-3 control-label')); ?>
                <div class="col-sm-7">
                    <?php echo $form->dropDownList($model, 'language_id', Languages::getListLanguage(), array('empty' => 'All', 'class' => 'form-control')); ?>

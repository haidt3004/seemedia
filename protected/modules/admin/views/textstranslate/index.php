...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('text-translate-grid', {
...
$('#clearsearch').click(function(){
	...
	$.fn.yiiGridView.update('text-translate-grid', {data: data});
	return false;
});

$('.deleteall-button').click(function(){
        var atLeastOneIsChecked = $('input[name=\"text-translate-grid_c0[]\"]:checked').length > 0;
        ...
        {
                document.getElementById('text-translate-grid-bulk').action='" . Yii::app()->createAbsoluteUrl('admin/' . Yii::app()->controller->id  . '/deleteall') . "';
                document.getElementById('text-translate-grid-bulk').submit();
        }
});
...
$('.updatestatusall-button').click(function(){
    ...
    {
    document.getElementById('text-translate-grid-bulk').action='" . Yii::app()->createAbsoluteUrl('admin/' . Yii::app()->controller->id  . '/updatestatusall') . "';
    document.getElementById('text-translate-grid-bulk').submit();
    }
});
...
Yii::app()->clientScript->registerScript('ajaxupdate', "
    $('#text-translate-grid a.ajaxupdate').on('click', function() {
        $.fn.yiiGridView.update('text-translate-grid', {
            type: 'POST',
            url: $(this).attr('href'),
            success: function() {

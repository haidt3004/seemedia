...
/**
 * This is the model class for table "{{_announcements_translate}}".
 *
 * The followings are the available columns in table '{{_announcements_translate}}':
 * @property integer $id
 ...
 */
class AnnouncementsTranslate extends _BaseModel {
	...
	{
		return '{{_announcements_translate}}';
	}
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, title, short_content, content, role_website_id, translate_id, language', 'safe'),
		);
	}
	 ...
	 * @return AnnouncementsTranslate the static model class
	 */
	...
	{
		return AnnouncementsTranslate::model()->count() + 1;
	}
}

 ...
 * Time: 9:30 AM
 */
class Policy extends _BasePostNoMulti{



    //multi language
    public $modelTranslate ='PoliciesTranslate';
    ...
    {
        return Policy::model()->findByPk((int)$id);
    }
    ...
    public function getAllGrid() {
        ...
        return new CActiveDataProvider('Policy', array(
            'criteria'=>$criteria,
            'pagination' => array(
                'pageSize' => 6,
            ),
     ...
     * @copyright 2015 Verz Design
     * @return string
     * @Todo: get description of Policy
     */

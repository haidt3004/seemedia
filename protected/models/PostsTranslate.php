...
/**
 * This is the model class for table "{{_posts_translate}}".
 *
 * The followings are the available columns in table '{{_posts_translate}}':
 * @property integer $id
 ...
 */
class PostsTranslate extends _BaseModel {
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, title, short_content, content, role_website_id, language, translate_id', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return PostsTranslate the static model class
	 */
	...
	{
		return PostsTranslate::model()->count() + 1;
	}
}

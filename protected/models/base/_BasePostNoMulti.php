 ...
 */
class _BasePostNoMulti extends _BaseModelNoMulti
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, title, short_content, content, status, posted_by, post_type, title_tag, meta_keywords, meta_desc, featured_image, display_order, created_date, modified_date, slug', 'safe'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'author_infos' => Yii::t('translation', 'About the Author'),
		);
	}

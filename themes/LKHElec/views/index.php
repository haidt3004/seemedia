<div class="mainchild">
	<div class="wrapper clearfix fullwidth">
		...
		<?php $this->widget('BannerWidget',array('group_banner_id' => 4,'layout' => 'inner_page_banner')); ?>
									...
									<div class="content_tab">
										<ul>
											<?php foreach ($policyModels as $policyModel) : ?>
                                                    <?php
                                                            $linkDoc=   str_replace('/view/preview','',$policyModel->short_content);
                                                     ?>
												<li class="list-news-item itemdowload">
													<a class="title handbook-modal" data-toggle="modal"
													   ...
													   link-ember="<?php echo $linkDoc . '/preview'; ?>"

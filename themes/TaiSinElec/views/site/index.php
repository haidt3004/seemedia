		...
		<div class="colleft">
			<div class="box-last-news">
				<div class="page-header-left">
					<?php echo TextMultilangHelper::label('latest-announcement'); ?>
				</div>
				<?php foreach($models as $model) : ?>
					<div class="item-news">
						<a href="<?php echo Yii::app()->createAbsoluteUrl('announcements/detail', array('slug' => $model->slug)); ?>"><?php echo $model->title; ?></a>
						<p class="date"><?php echo DateHelper::toDateMultiLang($model->created_date);  ?></p>
					</div>
				<?php endforeach; ?>
				<p class="learn-more"><a href="<?php echo Yii::app()->createAbsoluteUrl('announcements'); ?>"><i class="fa fa-caret-right"></i><?php echo TextMultilangHelper::label('read-more'); ?></a></p>
			</div>
			<!-- whisle blow banner -->
				...
				<?php foreach($modelHomes as $modelHome) : ?>
					...
					<div class="box-item-news">
						...
						<div class="info-box-news">
							...
							<p class="date-new"><?php echo DateHelper::toDateMultiLang($modelHome->created_date);  ?></p>
							<p><?php echo $modelHome->short_content; ?></p>
							<a href="<?php echo Yii::app()->createAbsoluteUrl('announcements/detail', array('slug' => $modelHome->slug)); ?>" class="r-more"><i class="fa fa-caret-right"></i><?php echo TextMultilangHelper::label('click-here'); ?></a>
						</div>
					</div>

    ...
    <div class="wrapper clearfix fullwidth">
        ...
        <div class="maincontent">
            <div class="t-header-org">
                <?php echo TextMultilangHelper::label('whistle-blow'); ?>
            </div>
            <div class="frm-edit">
...
<!--                <p>b) Copy the following email address <a href="mailto:--><?php //echo Yii::app()->params['adminEmail']; ?><!--">--><?php //echo Yii::app()->params['adminEmail']; ?><!--</a> and send using your personal email.</p>-->
            ...
            <div class="frm-edit">
                ...
                <div class="item-edit">
                    <label><?php echo TextMultilangHelper::label('title'); ?><span style="color: red;"> *</span></label>
                    <div class="ipt-edit">
                ...
                <div class="item-edit">
                    <label><?php echo TextMultilangHelper::label('message'); ?><span style="color: red;"> *</span></label>
                    <div class="ipt-edit">
...
<!--                --><?php //endif; ?>
                ...
                <div class="item-edit" style="clear:both;">
                    <label> &nbsp; </label><button type="submit" class="btn-sb"><?php echo TextMultilangHelper::label('submit'); ?></button>
                </div>

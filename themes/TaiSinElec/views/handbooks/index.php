	...
	<div class="wrapper clearfix fullwidth">
		...
		<div class="maincontent">
			<div class="t-header-org">
				<?php echo TextMultilangHelper::label('policy-org-chart'); ?>
			</div>
			...
			<div class="group-handbook clearfix">
							...
							<div class="panel-heading" role="tab" id="headingOne">
								<h4 class="panel-title">
									<a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
										<i class="fa fa-minus-circle"></i>  <?php echo TextMultilangHelper::label('policy'); ?>
									</a>
								</h4>
							</div>
									...
									<div class="content_tab">
										<ul>
											<?php foreach ($policyModels as $policyModel) : ?>
                                                <?php   $policyModel->getDataTranslate();?>
												<li class="list-news-item itemdowload">
                                                     <?php if($policyModel->short_content !=''): ?>
													<a class="title handbook-modal" data-toggle="modal"
													   ...
													   rel="policy-<?php echo $policyModel->id ?>"><?php echo $policyModel->title ?>
                                                    </a>
                                                    <?php else: ?>
                                                    <a class="title"><?php echo $policyModel->title ?></a>
                                                    <?php endif; ?>
							...
							<div class="panel-heading" role="tab" id="headingTwo">
								<h4 class="panel-title">
									<a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
										<i class="fa fa-minus-circle"></i> <?php echo TextMultilangHelper::label('organisation-chart'); ?>
									</a>
								</h4>
							</div>
									...
									<div class="content_tab">
										<ul>
											<?php foreach ($orgChartModels as $orgChartModel) : ?>
                                                <?php  $orgChartModel->getDataTranslate();?>
												<li class="list-news-item itemdowload">
                                                    <?php if($orgChartModel->short_content !=''): ?>
													<a class="title handbook-modal" data-toggle="modal"
													   ...
													   rel="org-chart-<?php echo $orgChartModel->id ?>"><?php echo $orgChartModel->title ?>
                                                    </a>
                                                    <?php else: ?>
                                                        <a class="title"><?php echo $orgChartModel->title ?>
                                                    </a>                                                    
                                                    <?php endif; ?>   
												</li>
											<?php endforeach; ?>
				...
				<div class="side-right">
					<div class="content-list-default document">
						<?php echo TextMultilangHelper::label('chart-showing-the-structure-of-the-organisation-and-employees-reporting-line'); ?>.
						<h4><?php echo TextMultilangHelper::label('policy'); ?></h4>
						<ul>
							<?php foreach ($policyModels as $policyModel) : ?>
								<li><?php echo $policyModel->title ?></li>
							<?php endforeach; ?>
						</ul>
						<h4><?php echo TextMultilangHelper::label('orgnisation-chart'); ?></h4>
						<ul>
							<?php foreach ($orgChartModels as $orgChartModel) : ?>
